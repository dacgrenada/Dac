...
const PRINT_CSS_PAID = `
  ...
  @media print {
    ...
    .header-left .logo      { color: #c87700 !important; }
    .header-left .logo-sub  { color: #888 !important; }
    .header-right .code       { color: #333 !important; }
    .header-right .code-label { color: #666 !important; }
    .satellite-wrap { background: #eee !important; border-color: #ddd !important; }
    .sv-wrap        { background: #eee !important; border-color: #ddd !important; }
...
<script>
  ...
  function startPayment() {
    // Store pending code so success.html can detect it
    ...
    // Poll localStorage every 2 seconds for payment confirmation
  ...
  function unlockLayout() {
    ...
    printStyle.textContent = \`
      ...
      @media print {
        ...
        body { display: block !important; color: #000 !important; }
        .no-print, #pay-bar { display: none !important; }
        .layout-card { border: 2px solid #c87700 !important; max-width: 100% !important; width: 100% !important; background: #fff !important; page-break-inside: avoid; break-inside: avoid; }
        .layout-header { background: #f5f5f5 !important; border-color: #c87700 !important; }
        .header-left .logo { color: #c87700 !important; }
        .header-left .logo-sub { color: #888 !important; }
        .header-right .code { color: #333 !important; }
