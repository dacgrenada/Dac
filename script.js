...
const STRIPE_PAYMENT_LINK = 'https://buy.stripe.com/test_4gMeV7cSk5TRdNldBf5wI0c';
...
function generateStickerPreview() {
  ...
  // ── Sticker payment script — clean, no Supabase ──
...
<script>
  ...
  function startPayment() {
    ...
    // Only fires if user actually navigated away (to Stripe) then came back
...
function generatePropertyLayout(isPaid = false) {
  ...
  // ── Layout payment script — clean, no Supabase ──
