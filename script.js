...
<div id="pay-bar" class="no-print" style="max-width:860px;margin:18px auto 0;display:flex;flex-direction:column;align-items:center;gap:12px;">
  ...
  <div id="waiting-bar" style="display:none;width:100%;background:rgba(240,165,0,0.08);border:1px solid rgba(240,165,0,0.3);border-radius:8px;padding:12px 18px;align-items:center;gap:12px;font-family:'IBM Plex Mono',monospace;font-size:12px;color:#f0a500;letter-spacing:0.06em;">
